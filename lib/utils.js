...
exports.bind = function (fn, scope /*, arguments*/) {
  if (fn.bind) return fn.bind.call.apply(fn.bind, arguments);
  var boundArgs = Array.prototype.slice.call(arguments, 2);
  return function() {
    var args = Array.prototype.slice.call(arguments, 0);
    return fn.apply(scope, boundArgs.concat(args));
  }
};
...
exports.highlightTags = function(name) {
  ...
  for (var i = 0, len = code.length; i < len; ++i) {
    exports.highlight(code[i]);
  }
};

/**
 * Highlight the content of the given DOM element.
 *
 * @param {Element} el
 * @api private
 */
